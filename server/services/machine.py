...
class MachineService:
    ...
    def register_machine(
        ...
        result = db.execute_one(
            ...
            INSERT INTO machines
                (mac_address, hostname, os_type, os_version, first_seen, last_seen, status)
            VALUES
                (%s, %s, %s, %s, NOW(), NOW(), 'online')
            ...
            with conn.cursor(cursor_factory=extras.RealDictCursor) as cur:
                ...
                cur.execute(
                    ...
                    INSERT INTO heartbeats
                        (machine_id, timestamp, idle_seconds, cpu_usage, memory_usage, is_idle)
                    VALUES (%s, %s, %s, %s, %s, %s)
                    """,
                    (machine_id, timestamp, idle_seconds, cpu_usage, memory_usage, is_idle),
                )
    ...
    def update_offline_machines() -> int:
        ...
        for m in (updated or []):
            logger.info(f"Machine marked offline: id={m['id']} hostname={m['hostname']}")
        return count
